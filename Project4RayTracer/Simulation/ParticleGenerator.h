...
enum GeneratorType {PointType, LineType, CircleType, BeamType, FireType, StarType};
...
//////////////////////////////////////////////////////////////////////////////
// @brief: Rectangle Generators - all particles spawn inside the rectangle surface
// with a random uniform distribution
struct Rectangle {
	glm::vec3 lowerLeftPoint;	// The lower left point of the rectangle
	float width;
	float height;
	glm::vec3 normal;
};
...
private:
	...
	Rectangle rectangle;			//< Rectangle generator
	...
	void fireGenerate(float sd);	//< Generate particles in uniform distribution
									//< with  fireGenerator
	void starGenerate();			//< Generate particles in uniform distribution
									//< with  starGenerator
