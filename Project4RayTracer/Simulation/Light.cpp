...
/////////////////////////////////////////////////////////////////////////////
// Transform the position of the light to be in camera coordinates
void 
Light::transformView(glm::mat4 view){
  //cout << "Light before: " << pos[0] << " " << pos[1] << " " << pos[2] << endl;
  glm::vec4 posVec4 = view*(glm::vec4(pos[0], pos[1], pos[2], pos[3]));
  pos[0] = posVec4[0];
  pos[1] = posVec4[1];
  pos[2] = posVec4[2];
  pos[3] = posVec4[3];
  //cout << "Light after: " << pos[0] << " " << pos[1] << " " << pos[2] << endl;
}
